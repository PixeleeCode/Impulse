export function showImpulseError(message) {
    var _a;
    let container = document.getElementById("impulse-error-container");
    if (!container) {
    ...
    const alreadyDisplayed = Array.from(container.children).some((child) => { var _a; return (_a = child.textContent) === null || _a === void 0 ? void 0 : _a.replace(/\s+/g, ' ').includes(message); });
    if (alreadyDisplayed) {
        return;
    }
  ...
  `;
    (_a = banner.querySelector("button")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
